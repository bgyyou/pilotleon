export const projects = [
  ...
  },
  {
    id: 'insurancehub',
    title: 'InsuranceHub',
    subtitle: '香港保险业全栈社交平台',
    description: '连接保险代理人、管理者和客户的社交平台，包含实时通讯、社区管理、AI内容摘要等功能。采用模块化架构实现7个核心模块，支持渐进式重构。技术栈：React + Supabase + REST APIs + TypeScript。',
    tech: ['React', 'Supabase', 'REST APIs', 'TypeScript', 'Claude API'],
    features: ['实时通讯', '社区管理', 'AI摘要', '项目管理', '模块化架构'],
    achievements: [
      '7个核心模块',
      '模块化架构',
      '渐进式重构'
